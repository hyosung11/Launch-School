...
* The Product Owner explains what Product Backlog items have been “Done” and what has not been “Done”;
  * Done
    * JS101 Lesson 2 > Assignments except Quiz
    * Finished *Mastery* book
    * Read *Learn Like a Pro* chapter daily
    * Watched *Learn Like a Pro* video course daily
    * Anki cards from JS100 - JavaScript Basics > Sections 1-5
    * Made Anki cards from JS101 Lesson 1 Quiz 1
    * Listened to *A Mind for Numbers* chapters daily on Audible
    * Started reading *The Pragmatic Programmer* again
...
* The Developers discuss *what went well* during the Sprint, *what problems it ran into*, and *how those problems were solved*;
  * What went well?
    ...
    * reviewing and editing my Anki cards
    * Read chapters from *Mastery* daily
    * Read chapters and watch videos from *Learn Like a Pro*
    * Used the Productivity Planner daily
    * Engaged the Pomodoro technique and took breaks regularly
  * What problems?
    * eye strain
    * strain in right forearm - carpal tunnel mild case
    * realized that I don't really know things as well as I think I do when it comes to actually writing code even if I have written an algorithm
  * What problems did I solve?
...
* The **Product Owner** discusses the Product Backlog as it stands. He or she projects likely target and delivery dates based on progress to date (if needed);
  * Take Lesson 2 Quiz 1 after reviewing Lesson 2
  * Start JS101 Lesson 3

* The entire group collaborates on what to do next, so that the Sprint Review provides valuable input to subsequent Sprint Planning;
  * Finish Anki cards for JS100
  * Review JS101 Lesson 2 curriculum
  * Work on small problems
  * Study sessions
  * Take Lesson 2 Quiz 1
