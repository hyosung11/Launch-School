/* 6:16 Alex hasn't shown up and the kitchen pipe is frozen.
...
console.log(topThreeWords("  '  ") === []);
console.log(topThreeWords(`In a village of La Mancha, the name of which I have no desire to call to mind, there lived not long since one of those gentlemen that keep a lance in the lance-rack, an old buckler, a lean hack, and a greyhound for
