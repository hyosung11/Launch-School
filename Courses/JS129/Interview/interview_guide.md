# Assessment JS129: Object Oriented Programming > Part 2: Study Guide for Interview (20220623 10:19)
...
2. You should understand
   ...
   3. **inheritance** in a JavaScript context.
      - In particular, you should understand **prototypal inheritance**.
...
- [x] Write out examples for every topic.
- [x] Make code snippets.
- [x] Write explanations for the code snippets.
...
### 10.5.1 Higher Order Functions - Functions that Accept Functions as Arguments
...
### 14.3 Strict Mode and Implicit Context
...
### 14.4 Method Execution Context (Implicit)
...
### 14.5 `new` and Implicit Execution Context
...
Passing functions as arguments can strip them of their intended context objects.
...
You can use the same solutions we used to solve a similar problem in the previous assignment.
