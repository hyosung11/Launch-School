# JS129 Assessment: Object Oriented Programming > Specific Topics of Interest > Study Guide Version 12.0 - 20220421 16:46
...
#### 1.2.5 Factory Function Example 4 - `createToy` and `createCar`
...
### 8.2.3 Mixin Example with Classes
...
### 8.2.4 Mixin Example with Factory Functions
...
For example 1, the execution context of the `play` method is the `omi` object. Here, `omi.play()` uses method call syntax whose implicit execution context is the calling object, `omi`.
...
```js
function repeatThreeTimes(func) { // passing a function as the argument
  func();
  func();
  func();
}
