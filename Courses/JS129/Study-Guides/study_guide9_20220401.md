# JS129 Assessment: Object Oriented Programming > Specific Topics of Interest > Study Guide Version8 9.0 - 20220401 09:05
...
How do we distinguish one from the other? The `in` operator as well as `hasOwnProperty()` allow us to check for property existence in an object. Both methods check if a property exists in an object. If it does, `true` is returned, and `false` otherwise.
...
### 1.1.4 Property Existence Operator/Method Table
